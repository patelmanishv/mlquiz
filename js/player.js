...
var recoveryData;
if (lbLocalStorage) {
recoveryData = lbLocalStorage.getItem("d22b573bc658484087199dbc27fac32f9fb90c19_recovery_data");
}
...
if (lbLocalStorage) {
try {
lbLocalStorage.setItem("d22b573bc658484087199dbc27fac32f9fb90c19_recovery_data", generate_suspend_data(true));
} catch (e) {
...
if (localStorage) localStorage.removeItem("d22b573bc658484087199dbc27fac32f9fb90c19_recovery_data");
...
var seed = 'd22b573bc658484087199dbc27fac32f9fb90c19';
this.dummy = true;
...
if (localStorage) {
localStorage.removeItem("d22b573bc658484087199dbc27fac32f9fb90c19_recovery_data");
}
});
